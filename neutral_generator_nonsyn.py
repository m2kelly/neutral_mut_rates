...
SPEED update is for the introns do not add an explicit list of the positions
instead keep as ranges and add index to start or end coordinates where needed 
